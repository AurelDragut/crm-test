...
class EinkaufzuVerkaufPreisCrudController extends AbstractCrudController
{
    public static function getEntityFqcn(): string
    {
        return EinkaufzuVerkaufPreis::class;
    }
    ...
    {
        return $crud
            ->setEntityLabelInSingular('EinkaufsPreis zu VerkaufsPreis')
            ->setEntityLabelInPlural('EinkaufsPreis zu VerkaufsPreis')
